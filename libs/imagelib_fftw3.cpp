...
void CImageIO::WriteRealImage(void **pix, const std::string &fileName, std::map<std::string, double> &params,
...
void CImageIO::WriteComplexImage(void **pix, const std::string &fileName, std::map<std::string, double> &params,
                                 const std::string &comment, const std::vector<unsigned> &position) {
  std::vector<unsigned> shape=GetShapeVector();
