...
public:
  ...
  virtual void WriteImage(float_tt **data, std::vector<unsigned> &shape, std::string &label, 
                              std::vector<unsigned> &position, std::string &comment,
                              std::map<std::string, double> &parameters);
  virtual void WriteImage(complex_tt **data, std::vector<unsigned> &shape, std::string &label, 
                                 std::vector<unsigned> &position, std::string &comment,
                                 std::map<std::string, double> &parameters);
private:
  QH5ptr m_qh5;
